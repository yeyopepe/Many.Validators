...
namespace Many.Validators.Concat.S2
{
	/// <summary>
	...
	public readonly struct AND<TValue, V1, V2>
		...
		where V2 : IValidator<TValue>
	{
		...
		public static implicit operator AND<TValue, V1, V2>(TValue value) => new AND<TValue, V1, V2>(value);
		...
		public static implicit operator TValue(AND<TValue, V1, V2> value) => value.Value;

		public static bool operator ==(object source, AND<TValue, V1, V2> other) => source.Equals(other);
		public static bool operator !=(object source, AND<TValue, V1, V2> other) => !source.Equals(other);
		...
		public override bool Equals(object obj)
		{
			...
			if (obj is TValue)
				...
				!(obj is AND<TValue, V1, V2>))
				return false;
			else
				comparison = this.Equals(((AND<TValue, V1, V2>)obj).Value);
